  ...
  const findings = [
    ...
    },
    {
      ...
      bullets: [
        ...
        <>From Model 2:</>,
        <>Female with education: Base = <span className="number-highlight">0.641</span>, Every year older: <span className="number-highlight">−1.0%</span> match rate</>,
        <>Male with education: Base = <span className="number-highlight">0.062</span>, Every year older: <span className="number-highlight">−0.2%</span> match rate</>
      ]
    }
  ];
